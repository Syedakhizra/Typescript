...
/* jesa ke ap is example dekh rahen hen ke hum ne asynchronous programming ko use kia he is men
hum ne ek function ka use kia he jo execute hone men time lagata he or uske bad hi humne 
rk or kam print karwaya he iska result yeh aya ke humare program ne us ka wait nhi kia balke jo dosra code tha wo run kardia phir
jese hi uski timing pori hoi to wo execute hogia
is programming men hum 3 cheezon ko parhen ge 
- promises
-  callback
- async await
*/